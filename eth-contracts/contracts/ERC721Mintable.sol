...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "can not approve to your own token");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == _tokenOwner[tokenId] || isApprovedForAll(_tokenOwner[tokenId], msg.sender), "Should either be owner of token or approved for all");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "require a valid address");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint256 tokenId) internal {
        require(_exists(tokenId), "Token should exist");
...
contract POVToken is ERC721Metadata("POVToken", "POV", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
